...
public class WeatherContract {
     ...
     * Play Store.
     */
    public static final String CONTENT_AUTHORITY = "com.delaroystudios.weatherapp";
    ...
    /*
     * Possible paths that can be appended to BASE_CONTENT_URI to form valid URI's that WeatherApp
